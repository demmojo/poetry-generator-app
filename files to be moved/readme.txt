Ensure that you have a compatible Linux based system (Ubuntu 18.04 for e.g) before completing the below steps.
...
4. Follow steps given in the following Github link:
